-- Function: rep_record03(timestamp without time zone, timestamp without time zone, character varying, integer)

-- DROP FUNCTION rep_record03(timestamp without time zone, timestamp without time zone, character varying, integer);

CREATE OR REPLACE FUNCTION rep_record03(i_date_beg timestamp without time zone, i_date_end timestamp without time zone, i_spmd_uid character varying, i_time_offset integer)
...
END;$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION rep_record03(timestamp without time zone, timestamp without time zone, character varying, integer)
  OWNER TO owner_track;
GRANT EXECUTE ON FUNCTION rep_record03(timestamp without time zone, timestamp without time zone, character varying, integer) TO public;
GRANT EXECUTE ON FUNCTION rep_record03(timestamp without time zone, timestamp without time zone, character varying, integer) TO owner_track;
GRANT EXECUTE ON FUNCTION rep_record03(timestamp without time zone, timestamp without time zone, character varying, integer) TO track_server_all;
COMMENT ON FUNCTION rep_record03(timestamp without time zone, timestamp without time zone, character varying, integer) IS 'Отчёт по нахождению в зоне';
